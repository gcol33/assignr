...
This vignette provides detailed mathematical background on the algorithms implemented in `couplr`. Understanding these algorithms can help you choose the right method for your specific problem and appreciate the theoretical foundations of assignment optimization.
...
`couplr` provides multiple algorithms for the linear assignment problem:
...
- **Basic usage**: `vignette("getting-started")` covers core `couplr` functionality and examples
