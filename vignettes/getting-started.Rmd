...
`couplr` provides a solution to the LAP with a tidy interface that integrates with the tidyverse ecosystem.
...
`couplr` provides a solution for linear assignment problems in R:
...
- **Source code**: Visit the [GitHub repository](https://github.com/gcol33/couplr) for examples and contributions
